...
void esp8266ArtNetRDM::_artPoll() {
  ...
  _artReplyBuffer[6] = 't';
  _artReplyBuffer[7] = 0;
  _artReplyBuffer[8] = ARTNET_ARTPOLL_REPLY & 0xff; // op code lo-hi
...
void esp8266ArtNetRDM::_artIPProgReply() {
  ...
  ipProgReply[6] = 't';
  ipProgReply[7] = 0;
  ipProgReply[8] = ARTNET_IP_PROG_REPLY & 0xff; // op code lo-hi
...
void esp8266ArtNetRDM::artTODData(uint8_t g, uint8_t p, uint16_t* uidMan, uint32_t* uidDev, uint16_t uidTotal, uint8_t state) {
  ...
  artTodData[6] = 't';
  artTodData[7] = 0;
  artTodData[8] = ARTNET_TOD_DATA & 0xff; // op code lo-hi
...
void esp8266ArtNetRDM::rdmResponse(rdm_data* c, uint8_t g, uint8_t p) {
  ...
  rdmReply[6] = 't';
  rdmReply[7] = 0;
  rdmReply[8] = ARTNET_RDM & 0xff;   // op code lo-hi
...
void esp8266ArtNetRDM::sendDMX(uint8_t g, uint8_t p, IPAddress bcAddress, uint8_t* data, uint16_t length) {
  ...
  _artDMX[6] = 't';
  _artDMX[7] = 0;
  _artDMX[8] = ARTNET_ARTDMX & 0xff; // op code lo-hi
